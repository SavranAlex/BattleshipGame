...
public class ProbabilisticGuessPlayerV3 implements Player {
        ...
        public void initialisePlayer(World world) {
            ...
            for (int i = world.numRow; i >= 0; i--) {
                for (int j = world.numColumn; j >= 0; j--) {
                ...
                while(iter.hasNext())
                {
                    ...
                    if(guess.column == coords.column && guess.row == coords.row)
                    {
                        ...
                        if(possibleShip.coordinates.isEmpty())
                        {
                            ...
                            //this.remainingShipsNames.remove(possibleShip.ship); //remove ship name from the list of remaining ships names
                            return answer;
                        }
                    }
                }
        ...
        public void update(Guess guess, Answer answer) { //needs to be fixed to correctly trace types of remaining ships
            ...
            if(answer.isHit == true)
            {
                ...
                if (answer.shipSunk != null) {
                    ...
                    System.out.println("ship removed " + answer.shipSunk.name() + " size: " + remainingShipsNames.size());
                    //hits.clear();
                }
            }
//        if (answer.shipSunk != null) {
...
//            if (remainingShips.contains("PatrolCraft")) {
//                type = 1;
//            }
